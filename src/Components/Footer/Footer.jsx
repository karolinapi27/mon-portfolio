  ...
  return (
    <footer id="contactFooter" className={styles.footer}>
      ...
      <div className={styles.contactInfo}>
        ...
        <p>LinkedIn : <a href="www.linkedin.com/in/karolina-p-32b292254" target="_blank" rel="noopener noreferrer" aria-label="Visitez mon profil LinkedIn">Visitez mon LinkedIn</a></p>
      </div>
